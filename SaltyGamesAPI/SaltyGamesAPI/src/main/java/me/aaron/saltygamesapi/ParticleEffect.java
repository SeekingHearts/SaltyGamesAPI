...
public enum ParticleEffect {
    ...
    ParticleEffect(final String packetName, final Environment environment)
    {
    ...
    public void animateReflected(final Player p, final Location location, final float speed, final int count)
    {
        try
        {
            ...
            ParticleEffect.setValue(packet, "a", this.packetName.replace("%id%", "" + this._id).replace("%data%", "" + this._data));
            ParticleEffect.setValue(packet, "b", (float) location.getX());
            ParticleEffect.setValue(packet, "c", (float) location.getY());
            ParticleEffect.setValue(packet, "d", (float) location.getZ());
            ParticleEffect.setValue(packet, "e", 0F);
            ParticleEffect.setValue(packet, "f", 0F);
            ParticleEffect.setValue(packet, "g", 0F);
            ParticleEffect.setValue(packet, "h", speed);
